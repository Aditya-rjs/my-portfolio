...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -z-10 top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] sm:w-[700px] sm:h-[700px] rounded-full bg-blue-500/5 blur-3xl" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">

          {/* ── Mobile: Image first (top), Desktop: Right column ── */}
          <motion.div
          ...
          >
            <div className="relative">
              ...
              {/* Smaller on mobile, grows on larger screens */}
              <div className="relative w-52 h-52 sm:w-72 sm:h-72 lg:w-96 lg:h-96 rounded-2xl overflow-hidden border border-border/50 shadow-2xl bg-muted">
                <Image
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-4 -left-4 bg-background border border-border rounded-xl px-3 py-2 sm:px-4 sm:py-2.5 shadow-lg">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="flex flex-col gap-5 lg:order-1 mt-8 sm:mt-10 lg:mt-0"
          >
            {/* Status badge */}
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-5 text-sm font-medium rounded-lg bg-blue-500 hover:bg-blue-600 text-white transition-all duration-200 shadow-sm hover:shadow-blue-500/25 hover:shadow-md"
              >
                View Projects
                <ArrowRight size={14} />
              </button>
              <a
                ...
                download
                className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-5 text-sm font-medium rounded-lg border border-border bg-background hover:bg-accent text-foreground transition-all duration-200"
              >
                <Download size={14} />
                Resume
              </a>
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-5 text-sm font-medium rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent transition-all duration-200"
              >
                Contact Me
              </button>
            </motion.div>
